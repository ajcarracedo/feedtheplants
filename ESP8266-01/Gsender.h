...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "My email in base 64 ->"; //https://www.base64encode.org/
        const char* EMAILBASE64_PASSWORD = "My password in base 64 ->"; //https://www.base64encode.org/
        const char* FROM = "mymail@gmail.com";
